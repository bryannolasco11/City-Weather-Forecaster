...
https://bryannolasco11.github.io/City-Weather-Forecaster/
...
Starting from scratch, Bryan made a Dashboard that can be seperated into four divs.  One div is the search form, the 2nd is the current conditions, the third is the search history, and the fourth is the five day forecast.  Local storage was used to store the cities that have been searched.  The content in the divs for the five day forecast and the search buttons were dynamically created based upon the length of the objects that had to be created.  Bryan's tutor helped him store the data and bring it out again.
